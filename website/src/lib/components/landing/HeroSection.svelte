...
<section id="hero" class="relative mx-auto mt-32 max-w-7xl px-6 text-center md:px-8">
	...
	>
		Instantly identify trusted and suspicious contacts in every email thread, giving you real-time
		defense against phishing risks.
	</p>
	<Button
